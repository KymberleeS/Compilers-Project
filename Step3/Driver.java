 ...
 * as well as check to make sure there are not duplicate variables within the same
 * scope.
 * <p>
 ...
 * file and either outputs a declaration error or all the symbol tabls and their variable
...
public class Driver {
    public static void main(String[] args) throws Exception {
        ...
        //CharStream input = CharStreams.fromFileName("./Step3-TestCases/inputs/test9.micro");
